...
def get_data(soup):
    ...
    film_url = ['https://www.imdb.com/' + k.find('a').attrs['href'][0:17] for k in film_info]

    data = pd.DataFrame(
        {'name': film_names, 'year': film_years, 'score': film_scores, 'actors': film_actors, 'film_url': film_url})
    return data
...
if __name__ == '__main__':
    ...
    # IMDB = get_soup("https://www.imdb.com/title/tt0111161/")
    print(next_url(IMDB))
    # print(get_data(IMDB))
